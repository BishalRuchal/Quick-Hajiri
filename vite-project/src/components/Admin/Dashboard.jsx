...
const Dashboard = () => {
  return (
    <div className='flex-grow bg-gray-300 p-6 mt-20 ml-1'>
    <h1 className="text-2xl font-bold mb-6 text-teal-800">Administrator Dashboard</h1>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-gray-100 p-6 shadow-md rounded-lg flex justify-between items-center hover:scale-105 transition-transform duration-300 w-45 h-40">
        <div className="flex flex-col">
